...
from transformer_window_common import build_fixed_train_windows, build_parser, prepare_run, write_outputs
from transformer_window_modes import run_fixed_train_mode


def main() -> None:
    parser = build_parser("Train one fixed Transformer model and score multiple sliding test windows.")
